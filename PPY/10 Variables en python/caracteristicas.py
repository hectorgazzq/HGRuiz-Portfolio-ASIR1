'''Práctica característica de las variables'''
...
# 7nombre_alumno = "Pedro" # Error por empezar por un número
...
print(nombre_curso, nombre_alumno1, tareasParaHacer, NotaFinal, modulos_para_estudiar, DIA_SEMANA)
